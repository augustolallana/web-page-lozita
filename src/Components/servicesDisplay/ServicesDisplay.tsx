                ...
                <div className="mt-8 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
                    ...
                    <div className="block rounded-sm border bg-gray-900 border-gray-800 p-8 shadow-xl transition hover:border-blue-950 hover:shadow-blue-950">
                        ...
                        <p className="mt-1 text-sm text-gray-300">
                            ...
                            aporto una mirada integral en lo que a un terreno o edificacion refiere. Ya sea 
					        corroborar escrituras, planificar o preveer recursos necesarios para el proyecto 
                            específico, mí compromiso es identificar y explotar debilidades y fortalezas para 
